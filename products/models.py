...
class Stock(models.Model):
    ...
    def clean(self):
        ...
        # Validación para asegurarse de que la fecha de vencimiento no sea anterior a la fecha actual
        if self.expiration_date and self.expiration_date < timezone.now().date():
            raise ValidationError({'expiration_date': 'La fecha de vencimiento no puede ser anterior a la fecha actual.'})
